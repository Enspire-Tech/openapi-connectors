# Google Cloud Build API v1 Connector
Creates and manages builds on Google Cloud Platform.

Specification: https://github.com/APIs-guru/openapi-directory/blob/main/APIs/googleapis.com/cloudbuild/v1/openapi.yaml

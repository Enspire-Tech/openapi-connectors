package com.boomi.connector.postmark_server;
...
public class CustomOperation extends OpenAPIOperation {
    ...
    protected Iterable<Map.Entry<String, String>> getHeaders(ObjectData data) {
        ...
        headerList.add(new AbstractMap.SimpleEntry<>("Content-Type","application/json"));
        headerList.add(new AbstractMap.SimpleEntry<>("Accept","application/json"));

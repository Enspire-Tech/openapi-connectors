package com.boomi.connector.amazon_kinesis_analytics;

import com.boomi.connector.amazon_kinesis_analytics.CustomOperationConnection;
...
public class CustomOperation extends OpenAPIOperation {
    ...
    private final String SERVICE = "kinesisanalyticsv2";

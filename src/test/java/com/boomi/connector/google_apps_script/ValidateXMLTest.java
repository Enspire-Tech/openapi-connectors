package com.boomi.connector.google_apps_script;
...
public class ValidateXMLTest {
    ...
    public void validateConnectorConfig() {
        String xml = "/connector-config-google_apps_script.xml";
    ...
    public void validateConnectorDescriptor() {
        String xml = "/connector-descriptor-google_apps_script.xml";

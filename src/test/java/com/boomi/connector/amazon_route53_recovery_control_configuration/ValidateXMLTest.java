package com.boomi.connector.amazon_route53_recovery_control_configuration;
...
public class ValidateXMLTest {
    ...
    public void validateConnectorConfig() {
        String xml = "/connector-config-amazon_route53_recovery_control_configuration.xml";
    ...
    public void validateConnectorDescriptor() {
        String xml = "/connector-descriptor-amazon_route53_recovery_control_configuration.xml";

package com.boomi.connector.amazon_sagemaker_edge_manager;
...
public class ValidateXMLTest {
    ...
    public void validateConnectorConfig() {
        String xml = "/connector-config-amazon_sagemaker_edge_manager.xml";
    ...
    public void validateConnectorDescriptor() {
        String xml = "/connector-descriptor-amazon_sagemaker_edge_manager.xml";

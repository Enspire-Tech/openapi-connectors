package com.boomi.connector.amazon_route53_recovery_cluster;
...
public class ValidateXMLTest {
    ...
    public void validateConnectorConfig() {
        String xml = "/connector-config-amazon_route53_recovery_cluster.xml";
    ...
    public void validateConnectorDescriptor() {
        String xml = "/connector-descriptor-amazon_route53_recovery_cluster.xml";

package com.boomi.connector.amazon_rekognition;
...
public class ValidateXMLTest {
    ...
    public void validateConnectorConfig() {
        String xml = "/connector-config-amazon_rekognition.xml";
    ...
    public void validateConnectorDescriptor() {
        String xml = "/connector-descriptor-amazon_rekognition.xml";

package com.boomi.connector.google_data_fusion;
...
public class ValidateXMLTest {
    ...
    public void validateConnectorConfig() {
        String xml = "/connector-config-google_data_fusion.xml";
    ...
    public void validateConnectorDescriptor() {
        String xml = "/connector-descriptor-google_data_fusion.xml";

package com.boomi.connector.docusign_esignature;
...
public class ValidateXMLTest {
    ...
    public void validateConnectorConfig() {
        String xml = "/connector-config-docusign_esignature.xml";
    ...
    public void validateConnectorDescriptor() {
        String xml = "/connector-descriptor-docusign_esignature.xml";

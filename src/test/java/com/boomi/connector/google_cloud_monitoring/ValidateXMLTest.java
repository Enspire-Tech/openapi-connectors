package com.boomi.connector.google_cloud_monitoring;
...
public class ValidateXMLTest {
    ...
    public void validateConnectorConfig() {
        String xml = "/connector-config-google_cloud_monitoring.xml";
    ...
    public void validateConnectorDescriptor() {
        String xml = "/connector-descriptor-google_cloud_monitoring.xml";

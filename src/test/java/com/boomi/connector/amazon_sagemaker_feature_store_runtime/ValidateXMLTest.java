package com.boomi.connector.amazon_sagemaker_feature_store_runtime;
...
public class ValidateXMLTest {
    ...
    public void validateConnectorConfig() {
        String xml = "/connector-config-amazon_sagemaker_feature_store_runtime.xml";
    ...
    public void validateConnectorDescriptor() {
        String xml = "/connector-descriptor-amazon_sagemaker_feature_store_runtime.xml";
